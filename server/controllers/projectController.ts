...
// 1. Controller function to make revision
...
- Make sure it's a complete, standalone HTML document
- Return HTML only, nothing else.`,
        },
        {
          role: "user",
...
// 2. Controller Function to rollback to a specific version
...
// 3. Controller function to delete a project
...
// 4. controller for getting project code for the preview
